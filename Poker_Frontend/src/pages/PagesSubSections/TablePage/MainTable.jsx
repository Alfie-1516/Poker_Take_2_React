...
export class MainTable extends Component {
  render() {
    ...
    let potValue = 500;
    return (
      <div className="p-6 h-[65%] border-2 rounded-tr-lg  border-l-0 border-[#8db48e] flex flex-col justify-center gap-3 items-center w-full bg-[url(/poker_table.webp)] bg-center lg:bg-size-[90%] bg-no-repeat">
